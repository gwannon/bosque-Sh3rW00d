...
exiftool -overwrite_original -Title="Bosque Sh3rW00d. Versión 0.2" -Author="@Gwannon" -Subject="Bosque Sh3rW00d es un ambientación cyberpunk para Savage Worlds en un mundo muy parecido a las historias de Robin Hood o Ivanhoe. Versión 0.1" ./temp.pdf
